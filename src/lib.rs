...
//! library parses those files into a strongly typed [`model::Quiz`] and renders
//! it to one of two export targets:
//!
//! * a single print-ready Markdown sheet with **no** answer key, and
//! * a Canvas *New Quizzes* QTI package suitable for import.
//!
